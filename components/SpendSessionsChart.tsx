...
import { policyAnnotations, weeklySpend } from "@/lib/mockData";

const products = [
  { key: "April", color: "#2563eb" },
  { key: "K-Tuvi", color: "#7c3aed" },
  { key: "Job-page", color: "#06b6d4" },
];
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Weekly spend by product vs. site sessions
          </p>
        </div>
          ...
          >
            ...
            {products.map((p) => (
              <Bar
                ...
                stackId="spend"
                fill={p.color}
                radius={p.key === "Job-page" ? [4, 4, 0, 0] : [0, 0, 0, 0]}
                barSize={36}
              />
            ))}
